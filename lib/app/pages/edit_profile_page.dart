              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    ElevatedButtonWidget(color: AppColors.blueTitle, text: 'SALVAR',),
                    const SizedBox(height: 24),
                    InkWell(
                      onTap: () {
                        showModalBottomSheet(
                              ...
                              return SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 24),
                                     ElevatedButtonWidget(color: AppColors.colorButtonWarning, text: 'EXCLUIR CONTA',onTap: () => Modular.to.navigate(AppRoutes.deleteAccountDetails),),
                                     SizedBox(height: 30.5),
                                     Text("CANCELAR",style: AppTextStyles.labelInputText.copyWith(color: AppColors.blueTitle),)
                                  ],
                                ),
                              );
                            });
